...
class World(object):
    ...
    def restart(self):
        ...
        self.depth_camera = self.world.spawn_actor(
            bp_depth, carla.Transform(carla.Location(x=-1.6, z=1.7)), attach_to=self.vehicle)
        ...
        self.segmentation_camera = self.world.spawn_actor(
            bp_segmentation, carla.Transform(carla.Location(x=-1.6, z=1.7)), attach_to=self.vehicle)
        ...
        self.rgb_camera = self.world.spawn_actor(
            bp_rgb, carla.Transform(carla.Location(x=-1.6, z=1.7)), attach_to=self.vehicle)    
